...
import { fetchNutritionMaterial } from "@/lib/thermofit-nutrition.functions";
...
export function NutritionPlanPdfViewer({ open, path, title, onClose }: Props) {
  const fetcher = useServerFn(fetchNutritionMaterial);
